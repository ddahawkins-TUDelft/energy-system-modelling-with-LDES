...
import results_viewer as rv #for viewing results
...
for index, values in df_casestudy.iterrows():
    ...
    if index == 0: #for debugging purposes just using the first one
        ...
        'weather_year_clustering_LDES_study/model_config/model_with_intracluster_cycle_condition.yaml', #model_with_intracluster_cycle_condition #model_which_accounts_for_op_year_surplus
        ...
        override_dict={
             ...
             'data_tables.time_varying_parameters.data': f"../data_tables/three_year_cluster/time_varying_parameters_temp_three_years.csv", #update location for timeseries data
