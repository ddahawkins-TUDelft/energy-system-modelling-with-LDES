...
model = calliope.read_netcdf('weather_year_clustering_LDES_study/results/three_year_cluster/with_intracluster_cycle_condition/results_years_[2016,2017,2018]_weight_[8,1,1].netcdf')
char_scatter_SOC(model)
model = calliope.read_netcdf('weather_year_clustering_LDES_study/results/three_year_cluster/with_surplus_tracking/results_years_[2016,2017,2018]_weight_[8,1,1].netcdf')
char_scatter_SOC(model)